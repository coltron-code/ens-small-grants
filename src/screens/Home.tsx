  ...
  return (
    <>
      <HeadingContainer>
        ...
        <Subheading>
          ENS DAO Small Grants allow $ENS holders to vote on projects to receive funding fund. Sponsored by the Public Goods and Ecosystem working group, these recurring small grants award 1Ξ to your favorite projects.{' '}
        </Subheading>
      </HeadingContainer>
      <RoundItemsOuter>
        <SectionHeading>
